 ...
 */
final class Version20240914044911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student_payment ADD create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD fees TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student_payment DROP create_at, DROP fees');
    }
}
