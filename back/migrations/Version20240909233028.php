 ...
 */
final class Version20240909233028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payement (id INT AUTO_INCREMENT NOT NULL, eleve_id INT NOT NULL, annee_scolaire VARCHAR(25) NOT NULL, fret_incription DOUBLE PRECISION DEFAULT NULL, fret_total DOUBLE PRECISION NOT NULL, fret_mois DOUBLE PRECISION DEFAULT NULL, status VARCHAR(25) NOT NULL, INDEX IDX_B20A7885A6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_connexion (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(50) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(25) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, tel VARCHAR(20) NOT NULL, mail VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
